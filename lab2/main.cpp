...
#define CAR_TOP_DIST        (PLANET_RADIUS + CAR_HEIGHT)  // Distance of the top 
                                                          // of a car from 
                                                          // planet's center.

#define EYE_INIT_DIST       (3.0 * CAR_TOP_DIST)  // Initial distance of eye 
                                                  // from planet's center.
...
#define VERT_FOV            45.0    // Vertical FOV (in degrees) of the 
                                    // perspective camera.

#define DESIRED_FPS         60      // Approximate desired number of frames 
                                    // per second.
...
void MyInit( void )
{
    ...
    glEnable( GL_NORMALIZE ); // Let OpenGL automatically renomarlize all 
                              // normal vectors.
}
